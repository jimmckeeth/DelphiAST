...
type
  ...
  public
    ...
    // FindNode([ntAbsolute, ntUnknown, ntExpression, ntIdentifier]) and
...
const
  OperatorsInfo: array [ntAddr..ntIsNot] of TOperatorInfo =
